...
|convertMSecondsToTicks|	Converts miliseconds in clock ticks				   | Board::convertMSecondsToTicks(uint64_t milis);																					   | seconds: Time in miliseconds																																																											   | Time in clock ticks			  |
