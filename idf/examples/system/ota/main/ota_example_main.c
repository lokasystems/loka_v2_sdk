...
#define EXAMPLE_WIFI_SSID "Wireless-N"
#define EXAMPLE_WIFI_PASS "asdfghjkl"
#define EXAMPLE_SERVER_IP   "104.199.88.193"
...
static bool connect_to_http_server()
{
	...
	if (getaddrinfo("update.loka.systems", "80", &hints, &res) != 0 || res == NULL) {
		ESP_LOGE(TAG, "NADA");
		return false;
	}
...
static void ota_example_task(void *pvParameter)
{
    ...
    */
    ...
    int get_len = asprintf(&http_request, GET_FORMAT, "/download_firmware/2906303", "update.loka.systems");
    if (get_len < 0) {
